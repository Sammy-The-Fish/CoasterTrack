...
import com.example.coastertrack.ui.viewmodel.TotalRollercoasterViewModel

@Composable()
fun TotalRollercoasterScreen(
    total: Int = 0,
    modifier: Modifier = Modifier,
    navController: NavController = rememberNavController()
) {
    val viewModel: TotalRollercoasterViewModel = hiltViewModel()
    val listState by viewModel.rollercoasterList
    val total by viewModel.coasterCount.observeAsState()
